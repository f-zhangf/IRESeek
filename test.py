...
if __name__ == '__main__':
    ...
    net_params['fea_info'] = 4 #1:seq; 2:seq,bpe; 3:seq,bpe,ss; 4:seq,bpe,bpp;5:seq,ss,bpe,bpp
    ...
    base_path = os.getcwd() + '/save_model/Aexperiment/Hyper_experiment/'
    


    over_path = model_base_path + 'ensemble_cnn_models/ensemble2/over/model_75.pth'
    under1_path = model_base_path + 'ensemble_cnn_models/ensemble2/under1/model_6.pth'
    under2_path = model_base_path + 'ensemble_cnn_models/ensemble2/under2/model_195.pth'
    under3_path = model_base_path + 'ensemble_cnn_models/ensemble2/under3/model_1.pth'
    sava_path = base_path + 'cnn_gcn_L/cnn_gcnL4/undersampling/' 
